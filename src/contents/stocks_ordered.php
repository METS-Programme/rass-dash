...
?>
    ...
    <article class="content dashboard-page" style="padding-top:84px;">
        <div class="title-block">
            <h1 class="title">Stock Ordered - <small>Number of ARV Regimens ordered by a Health Facility.</small></h1>
                    ...
                    <div class="card sameheight-item stats" data-exclude="xs">
                        <div class="card-block">
                            <div class="title-block">
                                ...
                                <p class="title-description">Total Ordered Stock Per Region</p>
                            </div>
